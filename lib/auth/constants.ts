...
/** Signed cookie proving this session already passed password (or MFA) checks. */
export const LOGIN_OK_COOKIE = "sterling_login_ok";
...
/** How long a remembered device stays signed in. */
